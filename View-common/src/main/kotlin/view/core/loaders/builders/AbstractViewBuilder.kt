...
import view.utils.mapBased.keys.delegates.readOnly.casts.CastingKey
...
abstract class AbstractViewBuilder<V: View>: ViewBuilder<V>, ViewKeys() {
    ...
    private fun applyExtras() {
        webExtras.nonNull { view.webExtras = HasKeys(it.toMutableMap()) }
        androidExtras.nonNull { view.androidExtras = HasKeys(it.toMutableMap()) }
        iosExtras.nonNull { view.iosExtras = HasKeys(it.toMutableMap()) }
    }
}
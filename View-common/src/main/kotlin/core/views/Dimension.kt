 ...
 *
 * Each dimension value is mapped to a dimension type that specifies how the [ViewTreeRenderer][core.renderers.ViewTreeRenderer]
...
object Dimension {
    ...
    enum class Type {
         ...
         *
         * Note that this value is unit-less, it is up to the [ViewTreeRenderer][core.renderers.ViewTreeRenderer] to
         * specify a unit.
         */
        EXPLICIT
    }

 ...
 * platform specific [ViewTreeRenderer][core.renderers.ViewTreeRenderer].
 *
 * Most view properties are implemented using custom property delegates that take care of validation
 * and updating the [ViewTreeRenderer][core.renderers.ViewTreeRenderer].
 * @see [core.views.propertyDelegates]
 * @see [utils.validators]
 *
 */
abstract class View {
     ...
     * [ViewTreeRenderer][core.renderers.ViewTreeRenderer].
     */
